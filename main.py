...
def main():
    ...
    #            ]
    flights = [Flight(0, 0, 0, 1, 100, 50),      # City 0 to 1
               Flight(1, 1, 120, 2, 200, 200),     # City 0 to 3
               
               Flight(2, 2, 220, 3, 240, 20),     # City 1 to 2
               Flight(3, 0, 0, 4, 10, 120),   # City 1 to 2
               
               Flight(4, 4, 30, 1,50, 100),  # City 2 to 4
               Flight(5, 3, 260, 5,270, 100),  # City 2 to 4
    ...
    # The three tasks
    route1 = flight_planner.least_flights_ealiest_route(0, 5, 0, 300)
